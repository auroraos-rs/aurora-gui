...
pub struct NativeOptions {
    ...
    /// Show the system background initially (default: `true`).
    ...
    /// Automatically apply the system pixel ratio from DConf (default: `true`).
    ///
    /// Only used on Aurora OS.
    pub use_pixel_ratio: bool,
}
...
pub struct CreationContext {
    ...
    ///
    /// Already applied to [`egui_ctx`] when [`NativeOptions::use_pixel_ratio`] is `true`.
    pub pixel_ratio: f32,
    ...
    pub font_settings: Option<crate::platform::services::FontSettings>,
}
